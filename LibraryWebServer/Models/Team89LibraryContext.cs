...
{
    public partial class Team89LibraryContext : DbContext
    {
        public Team89LibraryContext()
        {
        }

        public Team89LibraryContext(DbContextOptions<Team89LibraryContext> options)
            : base(options)
        {
        }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
                optionsBuilder.UseMySql("Server=atr.eng.utah.edu;User Id=u1078722;Password=hg1758;Database=Team89Library");
            }
        }
